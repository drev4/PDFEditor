...
| D5 | ~~**Erasure that is real**: account deletion and the PDF a form delete leaves behind~~ — done ([`features/0029`](../../features/0029-account-deletion-and-real-erasure.md)). **Per-account export was split out** and is still open | Privacy | — |
