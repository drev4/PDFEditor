...
- **The Team plan as something buyable.** `features/0013` shipped Free ↔ Pro only, because Team is priced per seat and that quantity has to be kept in step with `Membership`. The canvas's Team card has no purchase path.
