...
|---|---|---|---|
| Frontend unit / component | 53 specs, 435 tests | Vitest, `@testing-library/vue`, `@pinia/testing`, jsdom (`frontend/vitest.config.ts`) | Beside the code, `frontend/src/**/*.spec.ts` |
| Backend route (mocked Prisma) | 25 specs, 326 tests | Vitest, `supertest`, `vitest-mock-extended` | `backend/tests/*.spec.ts` |
