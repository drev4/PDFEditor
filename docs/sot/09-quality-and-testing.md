...
|---|---|---|---|
| Frontend unit / component | 56 specs, 481 tests | Vitest, `@testing-library/vue`, `@pinia/testing`, jsdom (`frontend/vitest.config.ts`) | Beside the code, `frontend/src/**/*.spec.ts` |
| Backend route (mocked Prisma) | 32 specs, 397 tests | Vitest, `supertest`, `vitest-mock-extended` | `backend/tests/*.spec.ts` |
