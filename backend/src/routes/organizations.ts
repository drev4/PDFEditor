 ...
 */
organizationsRouter.get('/', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
 ...
 */
organizationsRouter.post('/active', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
...
organizationsRouter.get('/responses', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
...
organizationsRouter.get('/entitlements', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireMembership(req)
...
organizationsRouter.get('/members', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireMembership(req)
...
organizationsRouter.patch('/members/:userId', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
...
organizationsRouter.delete('/members/:userId', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner'])
...
organizationsRouter.get('/invitations', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
...
organizationsRouter.post('/invitations', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
...
organizationsRouter.delete('/invitations/:id', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner', 'admin'])
...
organizationsRouter.post('/invitations/accept', invitationRateLimit, asyncHandler(async (req: AuthRequest, res, next) => {
...
organizationsRouter.get('/api-keys', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner', 'admin'])
...
organizationsRouter.post('/api-keys', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner', 'admin'])
...
organizationsRouter.delete('/api-keys/:id', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner', 'admin'])
...
organizationsRouter.get('/webhooks', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner', 'admin'])
...
organizationsRouter.post('/webhooks', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner', 'admin'])
 ...
 */
organizationsRouter.patch('/webhooks/:id', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner', 'admin'])
  const id = req.params.id as string
...
organizationsRouter.delete('/webhooks/:id', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const { organizationId } = await requireRole(req, ['owner', 'admin'])
  const id = req.params.id as string
