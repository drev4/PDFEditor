...
formsRouter.get('/', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
...
formsRouter.post('/', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
...
formsRouter.get('/:id', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
...
formsRouter.put('/:id', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const id = req.params.id as string
...
formsRouter.patch('/:id/status', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const id = req.params.id as string
...
formsRouter.get('/public/:shareId', asyncHandler(async (req, res, next) => {
...
formsRouter.get('/:id/responses', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const id = req.params.id as string
...
formsRouter.get('/:id/responses/export', authenticate, asyncHandler(async (req: AuthRequest, res, next) => {
  const id = req.params.id as string
