...
npm run test:backend             # Vitest + supertest over a mocked Prisma, 14 specs / 187 tests in backend/tests/
npm run test:integration         # Vitest + supertest over a REAL PostgreSQL, 13 specs / 139 tests in backend/tests/integration/
