...
npm run test:frontend            # Vitest, 29 specs / 241 tests beside the source
npm run test:backend             # Vitest + supertest over a mocked Prisma, 12 specs / 115 tests in backend/tests/
npm run test:integration         # Vitest + supertest over a REAL PostgreSQL, 3 specs / 25 tests in backend/tests/integration/
npm run test:e2e                 # Playwright, 38 tests; starts both apps itself
