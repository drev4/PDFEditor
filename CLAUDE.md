...
npm run test:frontend            # Vitest, 30 specs / 250 tests beside the source
npm run test:backend             # Vitest + supertest over a mocked Prisma, 12 specs / 115 tests in backend/tests/
npm run test:integration         # Vitest + supertest over a REAL PostgreSQL, 7 specs / 72 tests in backend/tests/integration/
npm run test:e2e                 # Playwright, 41 tests; starts both apps itself
