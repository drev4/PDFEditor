...
npm run test:frontend            # Vitest, 38 specs / 314 tests beside the source
npm run test:backend             # Vitest + supertest over a mocked Prisma, 14 specs / 178 tests in backend/tests/
npm run test:integration         # Vitest + supertest over a REAL PostgreSQL, 12 specs / 123 tests in backend/tests/integration/
